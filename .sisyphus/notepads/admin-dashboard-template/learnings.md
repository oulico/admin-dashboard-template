...
## [2026-04-07] T22: Feature barrels + routes
- routeTree.gen.ts is auto-generated by TanStack Router Vite plugin during build
- Route files must be created before running build to trigger regeneration

## [2026-04-07] T23: README
- Documented the FSD + Clean Architecture hybrid structure to guide future AI agents.
- Explicitly listed "Never read" paths to reduce context noise during agentic development.
- Verified that all 22 implementation tasks are reflected in the architecture and tech stack sections.
